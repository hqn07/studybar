                        ...
                        ForEach(fileTypes, id: \.0) { t in
                            Button { typeFilter = t.0 } label: {
                                Text(t.1).font(.caption)
                                    ...
                                    .background(typeFilter == t.0 ? AnyShapeStyle(.tint.opacity(0.2)) : AnyShapeStyle(Color.sbSurface), in: Capsule())
                    ...
                    LazyVStack(spacing: 4) {
                        ForEach(matches) { m in
                            Button { preview(m.url) } label: {
                                ...
                                .padding(9).background(Color.sbSurface, in: RoundedRectangle(cornerRadius: DS.Radius.card))
                            }.buttonStyle(.plain)
                        }
                    }.padding(10)
                }
